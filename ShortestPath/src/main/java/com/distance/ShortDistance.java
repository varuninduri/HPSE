...
public class ShortDistance {
    ...
    public String calculate(String matrixsize,String matrixfile ) throws IOException{


        // scanner 
        //Scanner input = new Scanner(System.in);
        //System.out.println("Please, Enter the path where the text file is stored");
        String file = matrixfile;
        ...
        return("Path: " + paths[shortPath] + ". Distance = " + finalResults[shortPath] + " (ShortestPath)");
